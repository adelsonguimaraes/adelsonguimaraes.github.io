...
-- Copiando dados para a tabela cfp.categoria: ~0 rows (aproximadamente)
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha`, `ativo`, `perfil`, `pushkey`, `datacadastro`, `dataedicao`) VALUES
	(1, 'Adelson Guimarçaes', 'adelsonguimaraes@gmail.com', '123', 'SIM', 'USUARIO', NULL, '2018-01-09 01:31:38', NULL);
