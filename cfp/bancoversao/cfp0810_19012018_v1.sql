...
CREATE TABLE IF NOT EXISTS `categoria` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Tipo de Despesa ou Recebimento';
...
INSERT INTO `categoria` (`id`, `descricao`, `tipo`, `sync`, `ativo`, `datacadastro`, `dataedicao`) VALUES
	...
	(4, 'Teste', 'APAGAR', 'SIM', 'SIM', '2018-01-18 14:10:25', '0000-00-00 00:00:00'),
	...
	(13, 'Mais 1', 'AMBOS', 'SIM', 'SIM', '2018-01-18 17:09:33', '2018-01-18 17:15:23');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Tabela Master de Conta(a pagar ou a receber)';
...
INSERT INTO `conta` (`id`, `idusuario`, `idcategoria`, `descricao`, `valor`, `parcela`, `indeterminada`, `tipo`, `status`, `datavencimento`, `sync`, `datacadastro`, `dataedicao`) VALUES
	(5, 1, 1, 'Teste', 0.00, 5, 'NAO', 'APAGAR', NULL, '0000-00-00', '', '0000-00-00 00:00:00', '2018-01-19 12:28:55');
...
INSERT INTO `usuario` (`id`, `nome`, `email`, `senha`, `ativo`, `perfil`, `pushkey`, `sync`, `datacadastro`, `dataedicao`) VALUES
	(1, 'Adelson Guimarçaes', 'adelsonguimaraes@gmail.com', '202cb962ac59075b964b07152d234b70', 'SIM', 'USUARIO', NULL, NULL, '2018-01-09 01:31:38', NULL);
